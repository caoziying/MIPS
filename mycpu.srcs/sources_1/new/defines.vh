...
// 数据移动指令  6
`define EXE_MOVZ  6'b001010     // Move Condition on Zero       第三个寄存器为0 复制一个寄存器到另外一个寄存器
`define EXE_MOVN  6'b001011     // Move Conditional on Not Zero 第三个寄存器不为0 复制一个寄存器到另外一个寄存器
`define EXE_MFHI  6'b010000     // Move From HI Register        从HI寄存器中读数据
`define EXE_MTHI  6'b010001     // Move To HI Register          将数据送入HI寄存器
...
`define EXE_PREF  6'b110011     // 预载

`define EXE_NOP 6'b000000
// 不能与其他指令同时 至少需要一个时钟周期
...
`define InstMemNum 1023 			//rom的实际大小为128k
`define InstMemNumLog2 10 			//ROM实际使用的地址线的宽度
